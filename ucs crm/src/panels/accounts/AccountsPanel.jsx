...
const SIM_NAV = [
  ...
  { id: 'sim-mobileid', path: '/accounts/sim/mobileid', label: 'Mobile IDs',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/><line x1="9" y1="18" x2="15" y2="18"/></svg>,
    match: (p) => p === '/accounts/sim/mobileid' },
  ...
  { id: 'sim-owner', path: '/accounts/sim/owner', label: 'SIM Owners',
  ...
  { id: 'sim-importexport', path: '/accounts/sim/importexport', label: 'Import / Export',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>,
    match: (p) => p === '/accounts/sim/importexport' },
