...
export default function MyLeadsSuspense() {
  ...
  return (
    <div style={{ height: '100%', position: 'relative', display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: 12, padding: 12, boxSizing: 'border-box', minHeight: 0 }}>
      <div style={{
