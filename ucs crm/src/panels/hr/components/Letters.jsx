...
<p style="margin:0 0 3px 0"><u><strong>Office Timings:</strong></u> All employees are required to maintain office hours from <strong>10:00 a.m. to 7:00 p.m.</strong>, Monday through Saturday.</p>
<p style="margin:0 0 3px 0"><u><strong>Office Guidelines:</strong></u></p>
<ul style="margin:0 0 3px 0;padding-left:22px">
<li style="margin-bottom:1px">Dress Code (Monday to Friday): Formals</li>
<li style="margin-bottom:1px">Dress Code (Saturday): Casuals</li>
<li style="margin-bottom:1px">Personal mobile phones are not permitted during working hours, except during lunch breaks.</li>
</ul>
<p style="margin:0 0 3px 0">All employees are expected to adhere to the highest standards of professionalism, integrity, and confidentiality. Any breach of the company's code of conduct or confidentiality policies may result in disciplinary action, including termination of employment.</p>
<p style="margin:0 0 3px 0">Please note that during the probation period, you will not be eligible for any other monetary benefits beyond the stipulated stipend. If an employee absconds or voluntarily leaves during the training period, they will not be eligible for any training salary or compensation.</p>
<p style="margin:0 0 3px 0">Kindly sign and return a copy of this appointment letter to confirm your acceptance of the terms and conditions outlined herein. Your appointment will be effective upon your acceptance.</p>
<p style="margin:0 0 3px 0">Congratulations on your appointment, and welcome to the team!</p>
</div>
<div style="margin-top:14px"><p style="margin:0 0 2px 0">Yours sincerely,</p><p style="margin:12px 0 0 0"><strong>HR,</strong><br />${hrNameText}<br /><strong>Ultimate Consultant Solutions (UCS)</strong></p></div>
<div style="margin-top:16px;padding-top:4px"><svg width="100%" height="14" viewBox="0 0 700 14" preserveAspectRatio="none" style="display:block;margin-bottom:3px"><path d="M0,7 Q175,0 350,7 Q525,14 700,7 L700,14 L0,14 Z" fill="#0B73C4" /></svg><div style="height:2px;background:#F58220;margin-bottom:6px"></div><div style="text-align:center;font-size:11px;color:#6b7280">    <strong>Regd. Address:</strong> 506, Sanjar Enclave, Bhadran Nagar, Kandivali (West), Mumbai, Maharashtra 400067.</div></div>
</div>`;
}
